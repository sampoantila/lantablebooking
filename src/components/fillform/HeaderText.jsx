        ...
        <div>
            ...
            <div className="ui black compact message">
                ...
                <ul className="list">
                    ...
                    <p>Meillä on useita tiloja yöpymiselle, tytöille ja pojille erikseen. Jotain patjaa tai pehmeähköä penkkiä löytyy, <p>mutta halutessasi voit tuoda oman patjan/ilmapatjan yms. jos haluat ja makuupussi/peitto yms. yöpymistarvikkeet.</p></p>
